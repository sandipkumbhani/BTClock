            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        if (result != null)
                        {
                            var userMenus = await _userMenuMappingService.GetUserMenuById(user.UserId);
                            ...
                            else
                            {
                                ...
                                var defaultMenus = menuitems.Where(m => m.MenuMaster.isDefault).ToList();

                                foreach (var menuitem in defaultMenus)
                                {
                                    var mappingDto = new UserMenuMappingDto
                                    {
                                        UserId = user.UserId,
