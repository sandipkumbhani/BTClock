    ...
    public class BaseClockInController : Controller
    {
        ...
        public override async Task OnActionExecutionAsync(ActionExecutingContext filterContext, ActionExecutionDelegate next)
        {
            ...
            if (role == "Admin" || role == "SuperAdmin")
            {
                ...
                var btclockMenuList = menuItems.Where(x => allMenuMasters.Any(m => m.Menuid == x.Menuid && m.ModuleMasterId == 1)).ToList();
            ...
            else
            {
                ...
                //var userMenuAccessList = menuItems.Where(x => userMenuList.Contains(x.MenuItemId)).ToList();
                ...
                var userMenuAccessList = menuItems
                    .Where(x => userMenuList.Contains(x.MenuItemId) && x.MenuMaster?.ModuleMasterId == 1)
                    .ToList();
