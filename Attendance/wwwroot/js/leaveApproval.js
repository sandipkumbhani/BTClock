        ...
        success: function (response) {
            ...
            if (response.data && response.data.length > 0) {
                ...
                $.each(response.data, function (index, detail) {
                    ...
                    var checkbox = "";
                    if (statusText == 0) {
                        checkbox = "<div class='form-check' style='margin-left:10px;'><input class='form-check-input' type='checkbox' value='' id='flexCheckDefault' style='background-size: 100% 100%;' Checked>";
                    }
                    else {
                        checkbox = "<div class='form-check' style='margin-left:10px;'><input class='form-check-input' type='checkbox' value='' id='flexCheckDefault' style='background-size: 100% 100%;' Checked disabled>";
                    }
